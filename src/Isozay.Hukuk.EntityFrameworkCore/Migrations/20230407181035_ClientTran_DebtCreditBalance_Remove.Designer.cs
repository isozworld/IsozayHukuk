...
namespace Isozay.Hukuk.Migrations
{
    ...
    [Migration("20230407181035_ClientTran_DebtCreditBalance_Remove")]
    partial class ClientTran_DebtCreditBalance_Remove
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Isozay.Hukuk.Clients.Client", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("HuClients", (string)null);
                });

            modelBuilder.Entity("Isozay.Hukuk.Clients.ClientRelation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    b.Property<long>("ChildClientId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HuClientRelations", (string)null);
                });
            ...
            modelBuilder.Entity("Isozay.Hukuk.Currencies.Currency", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HuCurrencies", (string)null);
                });
            ...
            modelBuilder.Entity("Isozay.Hukuk.Fiches.Fiche", b =>
                {
                    ...
                    b.ToTable("HuFiches", (string)null);
                });
            ...
            modelBuilder.Entity("Isozay.Hukuk.Fiches.FicheLine", b =>
                {
                    ...
                    b.Property<decimal>("FicheAmount")
                        .HasColumnType("decimal(65,30)");

                    b.Property<long>("FicheId")
                        .HasColumnType("bigint");

                    b.Property<decimal>("FicheQuantity")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("Isozay.Hukuk.Items.Item", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Isozay.Hukuk.Safes.Safe", b =>
                {
                    ...
                    b.ToTable("HuSafes", (string)null);
                });

            modelBuilder.Entity("Isozay.Hukuk.Safes.SafeTran", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HuSafeTrans", (string)null);
                });
