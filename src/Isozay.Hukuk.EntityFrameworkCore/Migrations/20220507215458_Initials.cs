        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TaxDep = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuClients", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuCurrencies", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuItems", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FicheNo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FicheDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuFiches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HuFiches_HuClients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "HuClients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HuFiches_HuCurrencies_CurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuSafes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HuSafes_HuCurrencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "HuCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyId = table.Column<long>(type: "bigint", nullable: false),
                    TrRate = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuClientTrans", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    FicheId = table.Column<long>(type: "bigint", nullable: false),
                    FicheQuantity = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    FicheAmount = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Vat = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    VatTotal = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    TrCurr = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    CurrencyId = table.Column<long>(type: "bigint", nullable: false),
                    FicheType = table.Column<int>(type: "int", nullable: false),
                    IO = table.Column<string>(type: "varchar(1)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuFicheLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HuFicheLines_HuCurrencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "HuCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HuFicheLines_HuFiches_FicheId",
                        column: x => x.FicheId,
                        principalTable: "HuFiches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuSafeTrans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HuSafeTrans_HuClients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "HuClients",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HuSafeTrans_HuCurrencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "HuCurrencies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HuSafeTrans_HuSafes_SafeId",
                        column: x => x.SafeId,
                        principalTable: "HuSafes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HuFicheLines_CurrencyId",
                table: "HuFicheLines",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_HuFicheLines_FicheId",
                table: "HuFicheLines",
                column: "FicheId");

            migrationBuilder.CreateIndex(
                name: "IX_HuFiches_ClientId",
                table: "HuFiches",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_HuFiches_CurrencyId",
                table: "HuFiches",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_HuSafes_CurrencyId",
                table: "HuSafes",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_HuSafeTrans_ClientId",
                table: "HuSafeTrans",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_HuSafeTrans_CurrencyId",
                table: "HuSafeTrans",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_HuSafeTrans_SafeId",
                table: "HuSafeTrans",
                column: "SafeId");
